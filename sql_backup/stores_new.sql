...
--
-- Host: localhost
-- Generation Time: Dec 03, 2017 at 05:36 PM
...
CREATE TABLE IF NOT EXISTS `books` (
  ...
  `author` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
...
INSERT INTO `book_carts` (`id`, `amount`, `cart_id`, `book_id`, `created_at`, `update_at`) VALUES
(332, 1, 43, 19, '2017-12-03 22:40:07', '2017-12-03 22:40:07'),
(333, 1, 43, 18, '2017-12-03 22:40:09', '2017-12-03 22:40:09'),
(334, 1, 43, 17, '2017-12-03 22:40:10', '2017-12-03 22:40:10');
...
INSERT INTO `carts` (`id`, `user_id`, `action`, `price_total`, `created_at`, `update_at`) VALUES
(43, 1, 'pending', 197000, '2017-12-03 22:39:55', '2017-12-03 22:39:55'),
(44, 1, 'waiting', 0, '2017-12-03 22:40:14', '2017-12-03 22:40:14');
...
DELIMITER $$
CREATE TRIGGER `set_waitting_cart` BEFORE INSERT ON `carts` FOR EACH ROW SET
NEW.action = 'waiting'
$$
DELIMITER ;
...
(4, 'xe', 'rÃ¡c', 'xe@gmail.com', NULL, '70873e8580c9900986939611618d7b1e', 0, NULL, NULL, '', NULL, '2017-12-03 09:09:39', '2017-12-03 09:09:39'),
(5, '123456', '123456', 'human@ss.com', NULL, '14e1b600b1fd579f47433b88e8d85291', 0, NULL, NULL, '', NULL, '2017-12-03 09:10:45', '2017-12-03 09:10:45'),
(6, 'viet', 'nguyen', 'xx@aa.com', NULL, 'e10adc3949ba59abbe56e057f20f883e', 0, NULL, NULL, '', NULL, '2017-12-03 09:13:28', '2017-12-03 09:13:28');
